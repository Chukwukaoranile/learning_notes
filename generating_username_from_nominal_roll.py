...
def to_mod_list(employee_list):
   ...
   employee_department = list(map(mod, employee_list))
...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   employee_username = [item.replace(" ", "_") for item in mod_list]
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   newdict = {username_generate['name'][0]: username_generate['id'] for username_generate in employee_list}
   return newdict
